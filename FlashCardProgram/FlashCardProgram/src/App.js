  ...
  constructor(props) {
    ...
    this.state = {
      cards: [ //10 sample cards to ensure that the program runs 
        ...
        { id: 3, english: "book", foreign: "pustaka" },
        { id: 4, english: "lamp", foreign: "batti" },
        { id: 5, english: "shoes", foreign: "jutta" },
        { id: 6, english: "laptop", foreign: "lyapatapa" },
        { id: 7, english: "box", foreign: "baksa" },
        { id: 8, english: "money", foreign: "paisa" },
        { id: 9, english: "phone", foreign: "phona" },
        { id: 10, english: "headphones", foreign: "hedaphona" },
      ],
      currentCardIndex: 0,
      currentCard: {}
    }
